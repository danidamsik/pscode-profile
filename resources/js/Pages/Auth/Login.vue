...
<template>
    <GuestLayout>
        ...
        <div v-if="status" class="mb-4 font-medium text-sm text-green-600 dark:text-tokyo-blue">
            {{ status }}
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 block">
                <label class="flex items-center">
                    ...
                    <span class="ms-2 text-sm text-gray-600 dark:text-tokyo-muted">Remember me</span>
                </label>
            </div>
